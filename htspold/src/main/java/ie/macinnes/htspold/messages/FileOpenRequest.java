...
public class FileOpenRequest extends RequestMessage {
    public static final String METHOD = "fileOpen";

    static {
        HtspMessage.addMessageRequestType(METHOD, FileOpenRequest.class);
    }
    ...
    public HtspMessage toHtspMessage() {
        ...
        htspMessage.putString("file", getFile());
