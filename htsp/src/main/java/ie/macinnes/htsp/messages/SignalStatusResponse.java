...
public class SignalStatusResponse extends ResponseMessage {
    static {
        HtspMessage.addMessageResponseType("signalStatus", SignalStatusResponse.class);
    }
    ...
    public String toString() {
        return "SignalStatus<subscriptionId: " + getSubscriptionId() + ">";
    }
}
