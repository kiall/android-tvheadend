...
public class SubscriptionGraceResponse extends ResponseMessage {
    static {
        HtspMessage.addMessageResponseType("subscriptionGrace", SubscriptionGraceResponse.class);
    }
    ...
    public String toString() {
        return "SubscriptionGrace<subscriptionId: " + getSubscriptionId() + ">";
    }
}
