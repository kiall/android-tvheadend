...
public class SubscriptionStopResponse extends ResponseMessage {
    static {
        HtspMessage.addMessageResponseType("subscriptionStop", SubscriptionStopResponse.class);
    }
    ...
    public String toString() {
        return "SubscriptionStop<subscriptionId: " + getSubscriptionId() + ">";
    }
}
