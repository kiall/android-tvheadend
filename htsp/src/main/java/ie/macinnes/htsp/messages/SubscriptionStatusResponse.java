...
public class SubscriptionStatusResponse extends ResponseMessage {
    static {
        HtspMessage.addMessageResponseType("subscriptionStatus", SubscriptionStatusResponse.class);
    }
    ...
    public String toString() {
        return "SubscriptionStatus<subscriptionId: " + getSubscriptionId() + ">";
    }
}
